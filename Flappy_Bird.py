...
game_font = pygame.font.Font('C:/Users/Admin/Downloads/04B_19.TTf',40)
...
#chen am thanh
flap_sound = pygame.mixer.Sound('sound/sound/sfx_wing.wav')
hit_sound = pygame.mixer.Sound('sound/sound/sfx_hit.wav')
score_sound=pygame.mixer.Sound('sound/sound/sfx_point.wav') 
